...
export type RunDetailSpecFragment = { __typename?: 'Spec', instanceId: string, spec: string, claimed: boolean, claimedAt: Maybe<string>, machineId: Maybe<string>, groupId: Maybe<string>, results: Maybe<{ __typename?: 'InstanceResults', tests: Array<{ __typename?: 'InstanceTest', state: TestState } | { __typename?: 'InstanceTestV5', state: TestState }>, stats: (
      { __typename?: 'InstanceStats' }
      & AllInstanceStatsFragment
    ) }> };
